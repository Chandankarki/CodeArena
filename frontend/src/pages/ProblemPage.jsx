...
//       console.log("Fetched problem:", res.data); // ➡️ inspect data

//       const startCodeArr = res.data.startCode;
//       if (!startCodeArr || !Array.isArray(startCodeArr)) {
//         throw new Error("Invalid or missing startCode in response");
//       }

//       const startCodeObj = startCodeArr.find(sc =>
//         sc.language.toLowerCase() === selectedLanguage.toLowerCase()
//       );

//       const initialCode = startCodeObj?.initialCode ?? '// No starter code available';
//       setProblem(res.data);
//       setCode(initialCode);
//     } catch (err) {
...
//       sc.language.toLowerCase() === selectedLanguage.toLowerCase()
//     );
//     const initialCode = startCodeObj?.initialCode ?? '// No starter code';
//     setCode(initialCode);
//   }
 ...
 useEffect(() => {
  const fetchProblem = async () => {
    ...
    try {
      ...
      const initialCode = matchedCode ? matchedCode.initialCode : '';
